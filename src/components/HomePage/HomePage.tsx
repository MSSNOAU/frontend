        ...
        <div className={styles.libDonContainer}>
          <div className={styles.eLibrary}>
            <div className={styles.desc}>
              ...
              <p>
                The New E-Library situated in the Central Mosque is now available for use between the hour of 8:00am to 4:00pm. Various islamic books majorly on hadeeth, biographies, Quran (in different languages) and many more are available.
                Various islamic books majorly on hadeeth, biographies, Quran (in different languages) and many more are available. 
              </p>
            </div>
          ...
          <div className={styles.donation}>
            <div className={styles.about}>
              ...
              <p className={styles.verse}>
                ...
                will have their reward with their Lord. On them shall be no fear, nor shall they grieve” (Q2:277)  
              </p>

              <div>
                <p>Your Donation to <strong>MSSN OAU</strong> Branch will help in the covering of the following;</p>
                <ul>
                  <li>BUS</li>
                  <li>Running the WEBSITE</li>
                  <li>MOSQUE PROJECT</li>
                  <li>Cater for the WELFARISM of the Muslim Students and others</li>
                </ul>
              </div>
              <Button
                label="More Reason For Donation"
                onClick={() => {}}
              />
            </div>
        ...
        <div className={styles.suggestionBox}>
          <div>
            <div className={styles.l}>
              ...
              <p className={styles.verse}>
                The <strong>MSSN OAU Executives</strong> really appreciate your effort by abiding with laws and doing the right thing. 
                However, we might not know some things you think we should more. That is why this platform is created so 
                as to hear from you. Muslim Students may assist. Not only do you aid your society, but you also support the professionals that we will one day become.
              </p>
